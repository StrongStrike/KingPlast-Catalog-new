...
import { KingplastSEO } from "../components/SEOHead";
...
export default function Index() {
  ...
  useEffect(() => {
    ...
    const updateActiveSection = () => {
      ...
      let currentBest = { section: activeSection, score: 0 };

      // Special handling for hero section at the very top
      if (scrollTop < 200) {
      ...
      for (const sectionId of sections) {
        ...
        // Score based on how centered the section is (0-1)
        ...
        // Apply hysteresis - if this is the current section, give it a bonus
        const adjustedScore =
          sectionId === activeSection ? finalScore + HYSTERESIS : finalScore;
      ...
      // Only update if we have a clear winner that's different from current
      if (
        currentBest.section &&
        currentBest.section !== activeSection &&
    ...
    const handleScroll = () => {
      ...
      scrollTimeout = setTimeout(updateActiveSection, SCROLL_DELAY);
    };
  ...
  useEffect(() => {
    const handleKeyDown = (e: KeyboardEvent) => {
      if (e.key === "Escape") {
        // ESC key handling is managed by individual components
      }
    };
  ...
  return (
    <ErrorBoundary>
      <AccessibilityProvider>
        <KingplastSEO />
        <ErrorMonitoring section="main" />
        <div
          className="font-jakarta bg-catalog-bg pb-safe"
          id="main-content"
          role="main"
        >
          ...
          <header
            ...
            role="banner"
            aria-label="KINGPLAST Royal Interior Collection 2025"
          >
            {/* Animated background */}
          ...
          <ProductCarousel
            title="King Plast 25 DekorPlast"
          ...
          <ProductCarousel
            title="King Plast 40 DekorPlast"
            subtitle="Professional seriya uchun"
            products={products["40"]}
            sectionId="section-40"
          />

          <ProductCarousel
            title="King Plast 60 DekorPlast"
              ...
              <div className="max-w-6xl mx-auto text-center">
                ...
                <div className="grid md:grid-cols-3 gap-8 mb-12">
                  <div className="space-y-4">
                    ...
                    <p className="text-white/80">9 ta turli kategoriya</p>
                  </div>

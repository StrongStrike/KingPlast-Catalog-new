...
const categories = [
  { id: "9", label: "9 taroq", section: "section-9" },
  { id: "12", label: "12 taroq", section: "section-12" },
  { id: "x12", label: "x12 taroq", section: "section-x12" },
  { id: "16", label: "16 taroq", section: "section-16" },
  { id: "18", label: "18 taroq", section: "section-18" },
  { id: "20", label: "20 taroq", section: "section-20" },
  { id: "25", label: "25 DekorPlast", section: "section-25" },
  { id: "40", label: "40 DekorPlast", section: "section-40" },
  { id: "60", label: "60 DekorPlast", section: "section-60" },
];
        ...
        {!isExpanded ? (
          ...
          <div className="bg-white/95 backdrop-blur-xl shadow-2xl border border-white/30 rounded-full px-4 py-3 flex items-center space-x-3">
            ...
            >
              ...
              <span className="text-royal font-medium text-sm truncate max-w-[80px]">
                {currentCategory?.label.split(" ")[1] || "taroq"}
              </span>
              <svg
          ...
          // Expanded mode
          <div className="bg-white/95 backdrop-blur-xl shadow-2xl border border-white/30 rounded-2xl p-3 w-72 max-w-[90vw]">
            {/* Header */}
